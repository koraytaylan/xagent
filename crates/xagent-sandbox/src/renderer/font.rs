...
fn glyph_bits(ch: char) -> GlyphBits {
    match ch {
        '0' => [
            0x3C, 0x66, 0x6E, 0x7E, 0x76, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00,
        ],
        '1' => [
        ...
        '6' => [
            0x3C, 0x66, 0x60, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00,
        ],
        '7' => [
        ...
        '9' => [
            0x3C, 0x66, 0x66, 0x66, 0x3E, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00, 0x00,
        ],
        'A' => [
        ...
        'E' => [
            0x7E, 0x60, 0x60, 0x60, 0x78, 0x60, 0x60, 0x60, 0x60, 0x7E, 0x00, 0x00,
        ],
        'F' => [
            0x7E, 0x60, 0x60, 0x60, 0x78, 0x60, 0x60, 0x60, 0x60, 0x60, 0x00, 0x00,
        ],
        'G' => [
        ...
        'J' => [
            0x1E, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x4C, 0x4C, 0x38, 0x00, 0x00,
        ],
        'K' => [
            0x66, 0x6C, 0x78, 0x70, 0x70, 0x78, 0x6C, 0x66, 0x66, 0x66, 0x00, 0x00,
        ],
        'L' => [
            0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x60, 0x7E, 0x00, 0x00,
        ],
        'M' => [
            0x63, 0x77, 0x7F, 0x6B, 0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x00, 0x00,
        ],
        'N' => [
        ...
        'W' => [
            0x63, 0x63, 0x63, 0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63, 0x63, 0x00, 0x00,
        ],
        'X' => [
            0x66, 0x66, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x00, 0x00,
        ],
        'Y' => [
            0x66, 0x66, 0x66, 0x66, 0x3C, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00, 0x00,
        ],
        'Z' => [
            0x7E, 0x06, 0x06, 0x0C, 0x18, 0x30, 0x60, 0x60, 0x60, 0x7E, 0x00, 0x00,
        ],
        'a' => [
        ...
        'f' => [
            0x1C, 0x36, 0x30, 0x30, 0x7C, 0x30, 0x30, 0x30, 0x30, 0x30, 0x00, 0x00,
        ],
        'g' => [
        ...
        'i' => [
            0x18, 0x00, 0x00, 0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
        ],
        'j' => [
            0x0C, 0x00, 0x00, 0x1C, 0x0C, 0x0C, 0x0C, 0x0C, 0x4C, 0x4C, 0x38, 0x00,
        ],
        'k' => [
            0x60, 0x60, 0x60, 0x66, 0x6C, 0x78, 0x78, 0x6C, 0x66, 0x66, 0x00, 0x00,
        ],
        'l' => [
            0x38, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x3C, 0x00, 0x00,
        ],
        'm' => [
            0x00, 0x00, 0x00, 0x76, 0x7F, 0x6B, 0x6B, 0x63, 0x63, 0x63, 0x00, 0x00,
        ],
        'n' => [
        ...
        't' => [
            0x00, 0x30, 0x30, 0x7C, 0x30, 0x30, 0x30, 0x30, 0x36, 0x1C, 0x00, 0x00,
        ],
        'u' => [
            0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x3E, 0x00, 0x00,
        ],
        'v' => [
            0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x3C, 0x18, 0x00, 0x00,
        ],
        'w' => [
            0x00, 0x00, 0x00, 0x63, 0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63, 0x00, 0x00,
        ],
        'x' => [
            0x00, 0x00, 0x00, 0x66, 0x66, 0x3C, 0x18, 0x3C, 0x66, 0x66, 0x00, 0x00,
        ],
        'y' => [
            0x00, 0x00, 0x00, 0x66, 0x66, 0x66, 0x66, 0x3E, 0x06, 0x66, 0x3C, 0x00,
        ],
        'z' => [
        ...
        _ => [
            0xFF, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0xFF, 0x00, 0x00,
        ],
    }
}
...
impl TextRenderer {
    ...
    pub fn build_texts(&self, items: &[TextItem]) -> (Vec<TextVertex>, Vec<u32>) {

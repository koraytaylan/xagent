...
| 0005 | GPU Occupancy & Brain-Pass Latency | 📋 Planned | 0/6 | Bank the measured ~10× evolution throughput by running at the GPU occupancy knee (population 10 → ≈200), profile the fused brain pass per-cooperative-pass, then ship-or-record one bit-identical latency reduction to the dominant pass. Guaranteed-concrete spine: occupancy + profile land unconditionally. | [status](0005-GPU-Occupancy-And-Brain-Latency/STATUS.md) |
